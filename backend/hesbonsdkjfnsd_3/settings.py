"""
Django settings for hesbonsdkjfnsd_3 project.
...
ROOT_URLCONF = 'hesbonsdkjfnsd_3.urls'
...
WSGI_APPLICATION = 'hesbonsdkjfnsd_3.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hesbonsdkjfnsd_3 API",
    "DESCRIPTION": "API documentation for hesbonsdkjfnsd_3 App",
    "VERSION": "v1",
}
